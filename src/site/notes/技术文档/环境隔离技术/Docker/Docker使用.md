---
{"dg-publish":true,"permalink":"/技术文档/环境隔离技术/Docker/Docker使用/","dg-note-properties":{}}
---
...
- `-f, --file <path string>`: 指定自定义构建配置文件名, `eg. ./Dockerfile.buildroot`
	...
	- 配置文件如何写参考[[技术文档/环境隔离技术/Docker/Docker配置\|Docker配置]]
### 示例
...
### 基本格式
**示例**
`eg. docker save -o debian_buster.tar debian:buster`
## load
本地加载镜像
### 基本格式

**示例**
`eg. docker load -i debian_buster.tar`
